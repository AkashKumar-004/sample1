                ...
                visible && (
                    <>
                        <div className="h-screen w-screen absolute top-0 left-0 bg-black/20 flex justify-center items-center z-50">
                         <div className=" w-[20%]">
                            <div className=" h-[30%] w-[100%] bg-red z-50 flex flex-col  bg-white  shadow-lg ">
                                ...
                                <div className="w-full flex flex-row justify-center items-center">
                                    <form className="w-[80%] flex flex-col justify-center items-center gap-4" onSubmit={handleAdd}>
